...
{
    public partial class form_2sp_uniforme : Form
    {
        int c;
        ...
        public form_2sp_uniforme()
        {
            InitializeComponent();
            chkArribo.Enabled = true;
        }
        ...
        private void form_2sp_uniforme_Load(object sender, EventArgs e)
        {
