...
namespace Trabajo_Practico_Simulacion.Servidores_en_Serie
{
    public partial class form_4ss_exponencial : Form
    {
        int c;
        bool arribo;
        ...
        public form_4ss_exponencial()
        {
            ...
            txtTDS4.Enabled = false;
            txtTDS4.Text = "0,1 ... 0,5 ... 0,9";
        }
            ...
            if (msj == 0)
            {
                ...
                for (int i = 0; i < tiempos.Length; i++)
                {
                    ...
                    else
                    {
                        ...
                        TDS.Add(Convert.ToDouble(this.txtTDS4.Text));
                    ...
                    cli_en_cola_s4.Series[nom_graf].Points.Add(new DataPoint(tiempos[i], ServidoresSerie_Exp.CantPromClientesColaS(3)));
                    ...
                    cli_cola4.Add(ServidoresSerie_Exp.CantPromClientesColaS(3));
                    ...
                    dem_prom_cli_s4.Series[nom_graf].Points.Add(new DataPoint(tiempos[i], ServidoresSerie_Exp.DemPromedioS(3)));
                    ...
                    dem_prom4.Add(ServidoresSerie_Exp.DemPromedioS(3));
                    ...
                    utilizacion_serv4.Series[nom_graf].Points.Add(new DataPoint(tiempos[i], ServidoresSerie_Exp.UtilServidor(3)));
                    ...
                    utilizacion4.Add(ServidoresSerie_Exp.UtilServidor(3));
