...
{
    public partial class form_4ss_weibull : Form
    {
        bool arribo;
        int c;
        ...
        public form_4ss_weibull()
        {
            ...
            txtTDS4_a.Enabled = false;
            txtTDS4_a.Text = "[0,1;0,9]";

            txtTDS4_b.Enabled = false;
            ...
            if (msj == 0)
            {
                ...
                for (int i = 0; i < tiempos.Length; i++)
                {
                    ...
                    else
                    {
                        ...
                        TDS_a.Add(Convert.ToDouble(this.txtTDS4_a.Text));
                        ...
                        TDS_b.Add(Convert.ToDouble(this.txtTDS4_b.Text));
                        MultiplesServidores = new ServidoresParalelo('w', c, TEA, TDS_a, TDS_b);
                    }
        ...
        private void chkServicio_CheckedChanged(object sender, EventArgs e)
        {
            if (chkServicio.Checked == true)
            {
                ...
                txtTDS3_b.Clear();
                txtTDS4_a.Enabled = true;
                txtTDS4_a.Clear();
                txtTDS4_b.Enabled = true;
                txtTDS4_b.Clear();
